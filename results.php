...
<html>
	<head>
		<title>Results | NEET demo test</title>
		<meta charset="UTF-8">
...
<div class="w3-theme">
    ...
    <a href="/Exams" class="w3-bar-item w3-button w3-hide-small kel-hover w3-hover-theme-dark w3-round"><i class="fa fa-list"></i> Register</a>
