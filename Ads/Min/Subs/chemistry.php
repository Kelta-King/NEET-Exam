...
<button class="w3-padding w3-large">
    <i class="fa fa-list-alt"></i> See all Chemistry questions <div class="w3-badge">
<?php
...
let addQuestion = () => {
	...
	let str = "q_no="+q_no+"&q_data_e="+q_data_e+"&q_op1_e="+q_op1_e+"&q_op2_e="+q_op2_e+"&q_op3_e="+q_op3_e+"&q_op4_e="+q_op4_e+"&q_ans_e="+q_ans_e+"&q_hint_e="+q_hint_e+"&q_data_g="+q_data_g+"&q_op1_g="+q_op1_g+"&q_op2_g="+q_op2_g+"&q_op3_g="+q_op3_g+"&q_op4_g="+q_op4_g+"&q_ans_g="+q_ans_g+"&q_hint_g="+q_hint_g+"&q_type='Chem'";
