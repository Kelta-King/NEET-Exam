...
<html>
	<head>
		<title>Donate | NEET demo test</title>
		<meta charset="UTF-8">
...
<div class="w3-theme">
    ...
    <a href="/Exams" class="w3-bar-item w3-button w3-hide-small kel-hover w3-hover-theme-dark w3-round w3-right"><i class="fa fa-list"></i> Register</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-animate-top">
    <a href="/Exams" class="w3-bar-item w3-button w3-theme-l1 w3-hover-theme-dark kel-hover" onclick="toggleFunction()"><i class="fa fa-list"></i> Register</a>
...
<div class="w3-center">
    <img class="w3-image" src="Images/underconstruction.png">
</div>
