...
if(isset($_SESSION['login_student']) && isset($_REQUEST['number']) && isset($_REQUEST['answer']) && isset($_SESSION['exam_subject'])){
    ...
    $query = "UPDATE que_stu_asn SET attempt = '1', s_ans = '$answer' WHERE q_number = $number AND subject = '$subject' AND s_id = $id";
