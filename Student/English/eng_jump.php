...
if(isset($_SESSION['login_student']) && isset($_REQUEST['number']) && isset($_SESSION['exam_subject'])){
    ...
    $query = "SELECT q_number, q_data, q_op1, q_op2, q_op3, q_op4 FROM questions WHERE q_number = $number AND q_sub = '".$_SESSION['exam_subject']."'";
    ...
    if($data = $conn->query($query)){
        ...
        echo $rslt['q_data']."#".$op1."#".$op2."#".$op3."#".$op4."#"."Question ".$rslt['q_number']."#";
