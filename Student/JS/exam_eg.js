...
let clearRes = () => {
	...
	xhttp.open("POST", "English/clear", true);
...
let save_time = (time) => {
	...
	xhttp.open("POST", "English/saveTime", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send(str);
...
let jump = (number) => {
	...
	xhttp.open("POST", "English/eng_jump", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send(str);
...
let mark = () => {
	...
	xhttp.open("POST", "English/mark", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send(str);
...
let next = () => {
	...
	xhttp.open("POST", "English/next", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send(str);
...
let updatePallete = () => {
	...
	xhttp.open("POST", "English/updatePallete", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send();
...
let save = () => {
    ...
    if(value == ""){
    	...
    	xhttp.open("POST", "English/save", true);
    	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    	xhttp.send(str);
...
let open_chem = () => {
	...
	xhttp.open("POST", "English/updateSub", true);
	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhttp.send(str);
